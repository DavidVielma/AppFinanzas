export const seedMovements = [
  ...
  { description: "Supermercado tarjeta", flow: "Movimiento", account: "Tarjeta de Credito", target_account: null, type: "Egreso", category: "Supermercado", amount: -302559, year: 2026, month: 4, status: "Confirmado" },
  { description: "Pago total tarjeta", flow: "Pago Tarjeta", account: "Principal", target_account: "Tarjeta de Credito", type: "Egreso", category: "Pago Tarjeta", amount: -302559, year: 2026, month: 4, status: "Confirmado" },
  ...
  { description: "Chat GPT", flow: "Movimiento", account: "Tarjeta de Credito", target_account: null, type: "Egreso", category: "Suscripciones", amount: -21939, year: 2026, month: 4, status: "Confirmado" },
  ...
  { description: "Supermercado mayo", flow: "Movimiento", account: "Tarjeta de Credito", target_account: null, type: "Egreso", category: "Supermercado", amount: -1077927, year: 2026, month: 5, status: "Proyectado" },
  { description: "Gastos del Viaje", flow: "Movimiento", account: "Tarjeta de Credito", target_account: null, type: "Egreso", category: "Viajes", amount: -656874, year: 2026, month: 5, status: "Proyectado" },
